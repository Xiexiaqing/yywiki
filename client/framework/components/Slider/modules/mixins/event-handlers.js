...
var EventHandlers = {
  ...
  swipeMove: function (e) {
    ...
    //disable horizontal move if deltaX < deltaY added by zx
    // if (this.state.touchObject.disableMove) {
    //   return;
    // }
    var swipeLeft;
    ...
    //disable horizontal move if deltaX < deltaY added by zx
    let { disableMove, firstMove } = touchObject;
    if(firstMove){
      let deltaX = touchObject.curX - touchObject.startX;
      let deltaY = touchObject.curY - touchObject.startY;
