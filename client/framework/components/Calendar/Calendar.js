    ...
    return (
      <div style={onlyClasses ? undefined : styles['MonthAndYear']} className={classes.monthAndYearWrapper}>
        <a
          ...
          className={classes.prevButton + ' W_ficon'}
          onClick={this.changeMonth.bind(this, -1)}> b 
        </a>
        <span>
          <span className={classes.year}>{year}年</span>
        ...
        <a
          ...
          className={classes.prevButton + ' W_ficon'}
          onClick={this.changeMonth.bind(this, +1)}> a
        </a>
      </div>
    )
  }
